...
func AddProductHandler(bot *tgbotapi.BotAPI, update tgbotapi.Update, productsCollection *mgo.Collection, ch tgbotapi.UpdatesChannel) tgbotapi.MessageConfig {
...
func GetAllProductsHandler(bot *tgbotapi.BotAPI, update tgbotapi.Update, productsCollection *mgo.Collection) tgbotapi.MessageConfig {
...
func RemoveProductHandler(update tgbotapi.Update, productsCollection *mgo.Collection) tgbotapi.MessageConfig {
